...
def home_page(request):
    ...
    if not alcances.exists():
        ...
        default_alcance = Alcance.objects.create(
        ...
        default_alcance.img_svg.save('default_alcance.svg', ContentFile(svg_content.encode()), save=True)
        alcances = [default_alcance]
    ...
    if not tipos_clientes.exists():
        ...
        default_tipo_cliente = TipoCliente.objects.create(
            nombre="Residencial",
            is_active=True
        )
        default_tipo_cliente.img_svg.save('default_tipo_cliente.svg', ContentFile(svg_content.encode()), save=True)
        tipos_clientes = [default_tipo_cliente]
